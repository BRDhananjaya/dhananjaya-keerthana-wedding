/* All invitation text lives here. Edit this file to change wording in either language. */
window.CONTENT = {
  meta: {
  ...
  en: {
    ...
    cdMins: "Minutes",
    cdSecs: "Seconds",
    countdownDone: "The auspicious moment is here. Thank you for your blessings!",

    inviteTitle: "With Joy &amp; Blessings",
    inviteBody:
      "Smt. Indramma C.H &amp; Sri. Ramesh M.B and Smt. Lakshmamma &amp; Sri. Ramakrishnegowda B.R solicit your gracious presence, with your family and friends, for the wedding ceremony of their children. Your presence and blessings on this auspicious occasion would mean the world to us.",

    brideFamilyTitle: "Bride's Family",
    brideParents: "Smt. Indramma C.H &amp; Sri. Ramesh M.B",
    ...
    muhurthamDay: "Wednesday, 14 October 2026",
    muhurthamTime: "9:00 am – 9:30 am",
    muhurthamNote: "Maangalya Dharane in the auspicious Vrushika Lagna",

    lagnaLabel: "Lagna",
    lagnaValue: "Vrushika",

    venueTitle: "The Venue",
    venueName: "Brundavana Convention Hall",
    venueAddress:
      "Tulasi Nagar, Vishwaneedam Post, Magadi Main Road,<br />Kempegowdanagar, Byadarahalli, Bengaluru – 560 091",
    venueButton: "Open in Google Maps",

    actionsTitle: "Be There With Us",
  ...
  kn: {
    ...
    cdMins: "ನಿಮಿಷ",
    cdSecs: "ಸೆಕುಂಡು",
    countdownDone: "ಶುಭ ಗಳಿಗೆ ಬಂದಿದೆ. ನಿಮ್ಮ ಆಶೀರ್ವಾದಕ್ಕೆ ಧನ್ಯವಾದಗಳು!",

    inviteTitle: "ಶುಭ ಆಮಂತ್ರಣ",
    inviteBody:
      "ಸ್ವಸ್ತಿಶ್ರೀ ವಿಜಯಾಭ್ಯುದಯ ಶಾಲಿವಾಹನ ಶಕ ವರ್ಷ 1948ನೇ ಶ್ರೀ ಪರಾಭವ ನಾಮ ಸಂವತ್ಸರದ ಆಶ್ವಯುಜ ಮಾಸ ಶುಕ್ಲ ಪಕ್ಷ, ದಿನಾಂಕ 14-10-2026ನೇ ಬುಧವಾರ ಬೆಳಿಗ್ಗೆ 09-00 ರಿಂದ 09-30 ಗಂಟೆಯೊಳಗೆ ಸಲ್ಲುವ ಶುಭ ವೃಶ್ಚಿಕ ಲಗ್ನದಲ್ಲಿ ಮಾಂಗಲ್ಯಧಾರಣೆ ನಡೆಸಲು ಗುರುಹಿರಿಯರು ನಿಶ್ಚಯಿಸಿದ್ದಾರೆ. ತಾವುಗಳು ಕುಟುಂಬ ಸಮೇತರಾಗಿ ಆಗಮಿಸಿ ವಧು-ವರರನ್ನು ಆಶೀರ್ವದಿಸಬೇಕೆಂದು ಕೋರಿಕೆ.",

    brideFamilyTitle: "ವಧುವಿನ ಕುಟುಂಬ",
    brideParents: "ಶ್ರೀಮತಿ ಇಂದ್ರಮ್ಮ. ಸಿ.ಎಚ್. ಮತ್ತು ಶ್ರೀ ರಮೇಶ್. ಎಂ.ಬಿ",
    ...
    muhurthamDay: "14-10-2026ನೇ ಬುಧವಾರ",
    muhurthamTime: "ಬೆಳಿಗ್ಗೆ 09.00 ರಿಂದ 09.30",
    muhurthamNote: "ಶುಭ ವೃಶ್ಚಿಕ ಲಗ್ನದಲ್ಲಿ ಮಾಂಗಲ್ಯಧಾರಣೆ",

    lagnaLabel: "ಲಗ್ನ",
    lagnaValue: "ವೃಶ್ಚಿಕ",

    venueTitle: "ಸ್ಥಳ",
    venueName: "ಬೃಂದಾವನ ಕನ್ವೆನ್ಷನ್ ಹಾಲ್",
    venueAddress:
      "ತುಳಸಿನಗರ, ವಿಶ್ವನೀಡಂ ಪೋಸ್ಟ್, ಮಾಗಡಿ ಮುಖ್ಯರಸ್ತೆ,<br />ಕೆಂಪೇಗೌಡನಗರ, ಬ್ಯಾಡರಹಳ್ಳಿ, ಬೆಂಗಳೂರು – 560 091",
    venueButton: "ಗೂಗಲ್ ಮ್ಯಾಪ್ಸ್‌ನಲ್ಲಿ ತೆರೆಯಿರಿ",

    actionsTitle: "ನಮ್ಮೊಂದಿಗೆ ಇರಿ",
